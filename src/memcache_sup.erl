...
%% @doc
%%   Starts the main supervisor of the memcache application.
%% @end
%%--------------------------------------------------------------------
...
child(Spec = #pool_spec{name = Name}) ->
    {Name, {memcache_pool_sup, start_link, [Spec]},
     permanent, infinity, supervisor, [memcache_pool_sup]}.
